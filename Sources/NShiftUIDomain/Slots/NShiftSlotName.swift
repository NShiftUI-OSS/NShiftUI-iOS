public struct NShiftSlotName: Equatable, Hashable, Sendable, ExpressibleByStringLiteral, CustomStringConvertible {
    ...
    public init(validating rawValue: String) throws(NShiftSlotNameError) {
...
public enum NShiftSlotNameError: Error, Equatable, Sendable {
