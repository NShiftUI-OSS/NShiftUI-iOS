public struct NShiftPluginName: Equatable, Hashable, Sendable, ExpressibleByStringLiteral, CustomStringConvertible {
    ...
    public init(validating rawValue: String) throws(NShiftPluginNameError) {
...
public enum NShiftPluginNameError: Error, Equatable, Sendable {
